...
choose_net = 8
# 0-vanilla 1-trans 2-trans_pointp 3-trans_pointp_se 4-pointp 5-connecttrans 6-eff 7-eff_pointp 8-eff_pointp_vlad_se 9-kmeans
...
def main():
    ...
    if opt.resume_refinenet != '':
        ...
        scheduler = CosineAnnealingWarmupRestarts(optimizer, first_cycle_steps=9, cycle_mult=1, max_lr=0.00012,
                                                  min_lr=0.00001, warmup_steps=1, gamma=0.72)
    else:
