...
def main():
    ...
    if opt.resume_refinenet != '':
        ...
        optimizer = optim.Adam(refiner.parameters(), lr=opt.lr, weight_decay=weight_decay)
    else:
        opt.refine_start = False
        opt.decay_start = False
        optimizer = optim.Adam(estimator.parameters(), lr=opt.lr, weight_decay=weight_decay)
